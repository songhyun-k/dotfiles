# Generated by Powerlevel10k configuration wizard on 2025-01-17 at 13:12 KST.
...
# angled separators, sharp heads, round tails, 2 lines, disconnected, left frame,
...
() {
  ...
  # Blue prompt symbol if the last command succeeded (catppuccin frappe blue).
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#8caaee'
  ...
  function my_git_formatter() {
    ...
    local      clean='%110F'
    local   modified='%223F'
    local  untracked='%151F'
    local conflicted='%210F'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=189
